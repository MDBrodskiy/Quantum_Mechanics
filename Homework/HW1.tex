...
\begin{enumerate}
  ...
  \item 
    ...
    \begin{enumerate}
      ...
      \item We may observe that the $S_z$ and $S_x$ probabilities remained invariant. On the other hand, the $S_y$ probabilities were dependent on the phase; that is, for a $\pi/2$ change in phase, the probabilties switch (the up probability becomes the down probability and vice versa). We may observe that the probabilities are equivalent for $\ket{\psi_2}$ and $\ket{\psi_3}$.
